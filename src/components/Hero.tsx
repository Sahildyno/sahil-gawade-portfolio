...
const Hero = ({
  ...
  return <div className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      {/* Enhanced animated background elements */}
      <div className="absolute inset-0">
        {floatingElements.map(element => <motion.div key={element.id} animate={{
        y: [-20, 20, -20],
        rotate: [0, 180, 360],
        scale: [1, 1.1, 1]
      }} transition={{
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          duration: 0.8
            ...
            duration: 0.8
              ...
              <Button onClick={() => scrollToSection('portfolio')} size="lg" className="bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 text-lg px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                <Play className="w-5 h-5 mr-2" />
                View My Work
              </Button>
              <Button onClick={() => scrollToSection('contact')} variant="outline" size="lg" className="border-2 border-blue-400/50 text-blue-400 hover:bg-blue-400 hover:text-white text-lg px-8 py-4 rounded-xl backdrop-blur-sm bg-white/5 transition-all duration-300 transform hover:scale-105">
                Let's Connect
              </Button>
<<<<<<< HEAD
              <Button
              ...
              Resume
=======
              <Button onClick={() => window.open('/resume.pdf', '_blank')} variant="ghost" size="lg" className="text-gray-300 hover:text-white border border-gray-600 hover:border-gray-400 px-8 py-4 rounded-xl backdrop-blur-sm bg-white/5 transition-all duration-300">
                <Download className="w-5 h-5 mr-2" />
                Resume
>>>>>>> baa9ad249c257943229925173f634d6214d755d8
              </Button>
